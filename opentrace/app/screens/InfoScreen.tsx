...
export default function InfoScreen({ route }) {
  const { navigation, data } = route.params;
    ...
    <>
      <SafeAreaView style={styles.container}>
          ...
          <ScrollView style={styles.containerBottom} contentContainerStyle={{ flexGrow: 1, alignItems: 'center' }}>
            ...
            <Text>{data["Unternehmen"]["Name"]} &#x2022; {country_codes[data["Herstellungsort"]]} &#x2022; {data["Barcode"]}</Text>
            <View style={styles.infobox}>
              ...
              <View style={styles.infoboxRight}>
                <Text style={styles.title}>{(distance/40075).toFixed(3).toString().replace(".", ",")}</Text>
            ...
            <View style={styles.subContainer}>
              ...
              <View style={styles.tablebox}>
                {data["Bestandteile"].map((value, index) => (<>
                  <TableRow key={index} left={value["Name"]} right={country_codes[value["Herstellungsort"]]} />
